...
import { Loader2, Copy, Link as LinkIcon, Github, GitBranch, GitFork, Star, FileText, Folder, Code, File, X, ExternalLink, MessageSquare, Search, Sparkles } from "lucide-react"
